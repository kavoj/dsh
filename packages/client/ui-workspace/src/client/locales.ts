...
export const zh = {
  ...
  'rename.ungrouped.title': '重命名未分组',
  'ungrouped.delete.title': '清空未分组',
  'ungrouped.delete.desc': '将把“未分组”下的 {n} 个会话全部归档。会话记录保留，可随时恢复。',
  'menu.fork': '分叉会话',
...
export const en = {
  ...
  'rename.ungrouped.title': 'Rename Ungrouped',
  'ungrouped.delete.title': 'Clear Ungrouped',
  'ungrouped.delete.desc': 'This archives all {n} sessions under Ungrouped. Session logs are kept and can be restored.',
