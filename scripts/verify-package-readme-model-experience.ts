...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/api/suixing-platform': { kind: 'none', reason: 'The bridge issues platform REST calls and registers no tool, prompt section, or Session event; the platform owns every model-visible effect.' },
  ...
  'packages/client/ui-brand-suixing': { kind: 'none', reason: 'Browser-side presentation occupants; registers nothing model-facing.' },
